...
(function (global) {
    ...
    class DesignManager {
        constructor() {
            ...
            document.addEventListener('fcAdvSettingChanged', e => {
                if (e.detail.key === 'advancedDesign') this._apply();
            });
        }
        ...
        _apply() {
            ...
            this.container.classList.remove('adv-design-glass', 'adv-design-phantom', 'adv-design-brutalist', 'adv-design-matrix');
    ...
    class AdvancedSettingsUI {
        ...
        _inputMap() {
            return {
                ...
                'fc-set-adv-design': { key: 'advancedDesign', type: 'text' },
            };
        }
